...
public abstract class WattDepot {
	 ...
	 */
	public abstract Location defineLocation(String id, Double latitude,
	 ...
	 */
	public abstract Sensor defineSensor(String id, String uri, Location l,
			SensorModel sm) throws UniqueIdException;
	 ...
	 */
	public abstract SensorProcess defineSensorProcess(String id, Sensor sensor,
	 ...
	 */
	public abstract WattDepository defineWattDepository(String id, String name,
			String measurementType) throws UniqueIdException;
	 ...
	 *             If the id is not known or defined.
	 */
	public abstract void deleteSensorGroup(String id)
			throws IdNotFoundException;
	 ...
	 *             If the id is not known or defined.
	 */
	public abstract void deleteSensorModel(String id)
			throws IdNotFoundException;
	 ...
	 *             If the id is not known or defined.
	 */
	public abstract void deleteSensorProcess(String id)
			throws IdNotFoundException;
	 ...
	 *             If the id is not known or defined.
	 */
	public abstract void deleteWattDepository(String id)
			throws IdNotFoundException;
