...
public class SensorProcess {
	...
	public String toString() {
		return "SensorProcess [id=" + id + ", sensor=" + sensor
				+ ", pollingInterval=" + pollingInterval + ", properties="
				+ properties + "]";
	}
	...
	/**
	 * @return The JSON version of this SensorProcess with full representation of the Sensor.
	 */
