...
/**
 * Represents a virtual water measurement an aggregation of several water
 * measurements.
 * 
 * @author Cam Moore
 */
@Entity
public class VirtualWaterMeasurement extends VirtualCounterMeasurement {
  /**
   ...
   */
  protected VirtualWaterMeasurement() {
  }

  /**
   * Creates a VirtualWaterMeasurement.
   * 
   * @param timestamp
   ...
   */
  public VirtualWaterMeasurement(Date timestamp, Double value, VirtualMeter meter) {
  ...
  public boolean equals(Object obj) {
    ...
    VirtualWaterMeasurement other = (VirtualWaterMeasurement) obj;
    if (properties == null) {
