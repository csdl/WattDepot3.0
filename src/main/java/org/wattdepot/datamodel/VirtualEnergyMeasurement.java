...
/**
 * Represents a virtual energy measurement, an aggregation of several energy measurements.
 * @author Cam Moore
 *
 */
@Entity
public class VirtualEnergyMeasurement extends VirtualCounterMeasurement {
  /**
   ...
   */
  protected VirtualEnergyMeasurement() {
  }

  /**
   * @param timestamp The time the measurement was made.
   * @param value The Energy Counter value.
   * @param meter The meter calculating the measurement.
   */
  public VirtualEnergyMeasurement(Date timestamp, Double value, VirtualMeter meter) {
  ...
  public boolean equals(Object obj) {
    ...
    VirtualEnergyMeasurement other = (VirtualEnergyMeasurement) obj;
    if (properties == null) {
