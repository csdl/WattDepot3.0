...
/**
 * Represents a power measurment.
 * 
 * @author Cam Moore
 */
@Entity
public class PowerMeasurement extends PointMeasurement {
  /**
   ...
   */
  protected PowerMeasurement() {
  }

  /**
   * Creates a new PowerMeasurement.
   * 
   * @param timestamp
   ...
   */
  public PowerMeasurement(Date timestamp, Double value, Meter meter, boolean interpolated) {
  ...
  public boolean equals(Object obj) {
    ...
    PowerMeasurement other = (PowerMeasurement) obj;
