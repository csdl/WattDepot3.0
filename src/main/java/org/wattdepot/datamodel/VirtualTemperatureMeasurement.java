...
/**
 * Represents a virtual temperature measurement, an aggregation of temperature
 * measurements.
 * 
 * @author Cam Moore
 */
@Entity
public class VirtualTemperatureMeasurement extends VirtualPointMeasurement {
  /**
   ...
   */
  protected VirtualTemperatureMeasurement() {
  }

  /**
   * Creates a new VirtualTemperatureMeasurement.
   * 
   * @param timestamp
   ...
   */
  public VirtualTemperatureMeasurement(Date timestamp, Double value, VirtualMeter meter) {
  ...
  public boolean equals(Object obj) {
    ...
    VirtualTemperatureMeasurement other = (VirtualTemperatureMeasurement) obj;
    if (properties == null) {
